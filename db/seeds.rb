...
Facility.create(name: "Facility", image: open("https://res.cloudinary.com/dev02l2pv/image/upload/v1547089074/section9-bg.png"),
...
puts "create producter"
Producter.create(name: "Producter", image: open("https://res.cloudinary.com/dev02l2pv/image/upload/v1547084262/section8-bg.png"))
producter_en = Producter.first.producter_languages.build(language: "en",
  left_text_1: "SMALL PRODUCERS AND FAMILY OPERATIONS",
  left_text_2: "A guarantee of quality",
...
producter_fr = Producter.first.producter_languages.build(language: "fr",
  left_text_1: "PETITS PRODUCTEURS ET EXPLOITATIONS FAMILIALES",
  left_text_2: "Un gage de qualité",
